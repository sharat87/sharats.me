...
BLOG_AUTHOR = "Shrikant Sharat Kandula"  # (translatable)
BLOG_TITLE = "The Sharat's"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://sharats.me/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://sharats.me/"
BLOG_EMAIL = "shrikantsharat.k@gmail.com"
BLOG_DESCRIPTION = "Sharat's random stuff"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        # ("/categories/", "Tags"),  # TODO: Show tag cloud at top of archive page.
        ('/pages/labs', 'Labs'),
        ('/shrikant-sharat-kandula-resume.pdf', 'Résumé'),
        ("/rss.xml", "RSS"),
        ('/pages/about', 'About'),
    ),
}
...
CONTENT_FOOTER = '''
    <p>
        ...
        Compiled by <a href="https://getnikola.com" target=_blank rel=nofollow>Nikola</a>.
        Hosted by <a href="https://www.netlify.com/" target=_blank rel=nofollow>Netlify</a>.
    </p>
    <p>{license}</p>
'''
...
# TODO: This is not working. Metadata in filename is ignored if the file contains YAML metadata.
#FILE_METADATA_REGEXP = r'.*[\/\\](?P<date>\d{4}-\d{2}-\d{2})_(?P<slug>.*)\.\w+'
